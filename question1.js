...
async function getCurrencies() {
    //Bugünün tarihiyle otomatik tarih atama
    ...
    // Bazı günler haftasonuna denk geldiği için verileri yok bu nedenle tarihi elimle atadım
    const dates = [
        {dd: '14'},
        {dd: '14'},
        {dd: '13'},
